            ...
            if downloaded_file:
                ...
                try:
                    ...
                    if status_code == 409:
                        ...
                        max_attempts = 4  # Set your desired maximum attempts
                        attempts = 0
                        while attempts < max_attempts:
                            ...
                            if ml_response.get('message') != 'Unique ID already existed':
                                attempts += 1
                                continue  # Exit the loop if upload is successful or a different error occurs
                            else:
                                break
...
print("process docmlNewId_mapping",postId_to_mlNewId_mapping)
