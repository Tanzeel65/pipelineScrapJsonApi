                ...
                try:
                    ...
                    if status_code == 409:
                        ...
                        if file_status_response == 200:
                         ...
                         existing_apidata = data_collection.find_one({"postId": post_id})
                         print('existing apidata',existing_apidata)
                         if existing_apidata:
                              data_collection.update_one({"postId": post_id},{"$set": ml_response})
